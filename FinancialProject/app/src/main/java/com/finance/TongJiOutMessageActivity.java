...
public class TongJiOutMessageActivity extends BaseActivity {
	...
	public void initData() {
		list_result = (List<PayModel>)this.getIntent().getSerializableExtra("msg");


		for (int i = 0; i < list_result.size(); i++) {


			mAxisValues.add(new AxisValue(i, list_result.get(i).getTypePayName().toCharArray()));
		}
//
