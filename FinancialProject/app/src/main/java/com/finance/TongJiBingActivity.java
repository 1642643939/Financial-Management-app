...
public class TongJiBingActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bingtongji_detail);
		setWindowStatus();
		initWidget();
		initData();
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.mIvBack:
			TongJiBingActivity.this.finish();
			break;
