...
public class MainZXFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
	    	...
	    	View rootView = inflater.inflate(R.layout.fragment_imtype, null);
	    	/**
		* 初始化三个Fragment  并且填充到ViewPager
		*/
		vPager = (ViewPager) rootView.findViewById(R.id.viewpager_home);
		ZheXianShouRuFragment imMessageFragment=new ZheXianShouRuFragment();
		ZheXianZhiChuFragment videoFragment=new ZheXianZhiChuFragment();
