...
import com.finance.util.MoneyUtils;
...
public class TotalMoneyFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_im_tip, null);
        /**
         * 初始化三个Fragment  并且填充到ViewPager
         */
        vPager = (ViewPager) rootView.findViewById(R.id.viewpager_home);
        TJMoneyShouRuFragment imMessageFragment=new TJMoneyShouRuFragment();
        TJMoneyZhiChuFragment videoFragment=new TJMoneyZhiChuFragment();
