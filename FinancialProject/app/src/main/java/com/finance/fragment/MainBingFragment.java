...
public class MainBingFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
		...
		*/
		...
		BingShouRuFragment imMessageFragment=new BingShouRuFragment();
		BingZhiChuFragment videoFragment=new BingZhiChuFragment();
