...
public class BingShouRuFragment extends BaseFragment {
    ...
    private List<IncomeModel> list_result = new ArrayList<IncomeModel>();
            ...
            case Consts.actionId.resultFlag:
                if (null != entry.getData() && !TextUtils.isEmpty(entry.getData())) {
                    ...
                    if (null != jsonMsg && !TextUtils.isEmpty(jsonMsg)) {
                        ...
                        list_result = mGson.fromJson(entry.getData(), new TypeToken<List<IncomeModel>>() {
                        }.getType());
    ...
    private void initPieChart() {
        ...
        pieChardata.setCenterText1(list_result.get(0).getTypeIncomeName());
    ...
    private PieChartOnValueSelectListener selectListener = new PieChartOnValueSelectListener() {
        ...
        public void onValueSelected(int arg0, SliceValue value) {
            // 选择对应图形后，在中间部分显示相应信息
            pieChardata.setCenterText1(list_result.get(arg0).getTypeIncomeName());
