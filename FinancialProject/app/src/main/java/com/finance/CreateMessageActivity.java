...
public class CreateMessageActivity extends BaseActivity {
    ...
    private String choiceTypeMoney = "微信";
    private RadioGroup mrgChoiceMoney;
    ...
    public void initWidget() {
        ...
        mrgChoiceMoney = (RadioGroup) findViewById(R.id.mrgChoiceMoney);
    ...
    public void initData() {
        ...
        mrgChoiceMoney.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
